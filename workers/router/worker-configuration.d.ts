/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../asset-service/wrangler.jsonc` (hash: 97621461b2167237dfaa9d1623dd6991)
// Runtime types generated with workerd@1.20260128.0 2025-11-11 enable_ctx_exports,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		KV_SERVER_SIDE_CODE: KVNamespace;
		ANALYTICS: AnalyticsEngineDataset;
		RATE_LIMIT_API: RateLimit;
		RATE_LIMIT_PROJECT: RateLimit;
		LOADER: WorkerLoader;
		VERSION: WorkerVersionMetadata;
		ASSETS: Fetcher;
		API_TOKEN: string;
		JWT_SECRET: string;
		ASSET_WORKER: Service<typeof import("../asset-service/src/worker").default>;
	}
}
