/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2e61a3a340d8b5d1a41086e44fde65c9)
...
declare namespace Cloudflare {
	...
	interface Env {
		PROJECTS_KV_NAMESPACE: KVNamespace;
		SERVER_CODE_KV_NAMESPACE: KVNamespace;
		API_TOKEN: string;
		JWT_SECRET: string;
		LOADER: WorkerLoader;
		ASSET_WORKER: Fetcher /* asset-worker-api */;
	}
}
